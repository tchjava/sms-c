...
layui.define(['jquery'], function (exports) {
    var $ = layui.jquery;
    var noAnchorClass = 'dropdown-no-anchor';  // 涓嶈灏忎笁瑙�
    var hasShadeClass = 'dropdown-has-shade';  // 鍔犻伄缃╅鑹�
    var triggerOpenClass = 'dropdown-open';  // 鎵撳紑
    var dropdownOpenClass = 'dropdown-opened';  // 鎵撳紑
    var dropdownDisableClass = 'dropdown-disabled';  // 绂佺敤
    var htmlNoScrollClass = 'dropdown-no-scroll';  // 绂佹婊氬姩
    var shadeClass = 'dropdown-menu-shade';  // 閬僵灞�
    var anchorClass = 'dropdown-anchor';  // 灏忎笁瑙�
    ...
    var dropdown = {
        ...
        showDropdown: function (target) {
            ...
            var isOpen = $trigger.hasClass(triggerOpenClass);  // 鏄惁宸插睍寮€
            var isDisabled = $trigger.hasClass(dropdownDisableClass);  // 鏄惁绂佺敤
